...
type MeshClient interface {
	...
	JoinNetwork(ctx context.Context, in *NodeAccount, opts ...grpc.CallOption) (grpc.ServerStreamingClient[CommitteeInfo], error)
	// 노드가 메시지를 브로드캐스트할 때 JoinNetowrk의 stream으로 전송
	// 즉, JoinNetwork로 subscribe한 노드들에게 데이터를 보낸다는 의미
	Publish(ctx context.Context, in *CommitteeInfo, opts ...grpc.CallOption) (*Ack, error)
	...
	RequestCommittee(ctx context.Context, in *Metrics, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *meshClient) JoinNetwork(ctx context.Context, in *NodeAccount, opts ...grpc.CallOption) (grpc.ServerStreamingClient[CommitteeInfo], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Mesh_ServiceDesc.Streams[0], Mesh_JoinNetwork_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[NodeAccount, CommitteeInfo]{ClientStream: stream}
...
type Mesh_JoinNetworkClient = grpc.ServerStreamingClient[CommitteeInfo]

func (c *meshClient) Publish(ctx context.Context, in *CommitteeInfo, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
...
func (c *meshClient) RequestCommittee(ctx context.Context, in *Metrics, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, Mesh_RequestCommittee_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MeshServer interface {
	// 최초 네트워크 진입 시 committee 정보 수신을 위한 subscribe에  필수
	JoinNetwork(*NodeAccount, grpc.ServerStreamingServer[CommitteeInfo]) error
	// 노드가 메시지를 브로드캐스트할 때 JoinNetowrk의 stream으로 전송
	// 즉, JoinNetwork로 subscribe한 노드들에게 데이터를 보낸다는 의미
	Publish(context.Context, *CommitteeInfo) (*Ack, error)
	// graceful-shutdown을 위한 option(없어도 자동 감지되어 연결해제됨)
	LeaveNetwork(context.Context, *NodeAccount) (*Ack, error)
	RequestCommittee(context.Context, *Metrics) (*Ack, error)
...
func (UnimplementedMeshServer) JoinNetwork(*NodeAccount, grpc.ServerStreamingServer[CommitteeInfo]) error {
	return status.Errorf(codes.Unimplemented, "method JoinNetwork not implemented")
}
func (UnimplementedMeshServer) Publish(context.Context, *CommitteeInfo) (*Ack, error) {
...
func (UnimplementedMeshServer) RequestCommittee(context.Context, *Metrics) (*Ack, error) {
...
func _Mesh_JoinNetwork_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MeshServer).JoinNetwork(m, &grpc.GenericServerStream[NodeAccount, CommitteeInfo]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Mesh_JoinNetworkServer = grpc.ServerStreamingServer[CommitteeInfo]
...
func _Mesh_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeshServer).Publish(ctx, req.(*CommitteeInfo))
	}
...
func _Mesh_RequestCommittee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeshServer).RequestCommittee(ctx, req.(*Metrics))
	}
	return interceptor(ctx, in, info, handler)
}
